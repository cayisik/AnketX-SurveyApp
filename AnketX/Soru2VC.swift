...
class Soru2VC: UIViewController {
    @IBOutlet weak var anketAdiLbl: UILabel!
    @IBOutlet weak var soruIkiTxt: UITextField!
    ...
    {
        if soruIkiTxt.text != "" && aSikkiTxt.text != "" && bSikkiTxt.text != "" && cSikkiTxt.text != "" && dSikkiTxt.text != ""
        {
            ...
            else
            {
                if snapshot?.isEmpty == false && snapshot != nil
                {
                    for anketler in snapshot!.documents
                    {
                        ...
                        {
                            soruDizi.append(self.soruIkiTxt.text!)
                            ...
                            dbBaglanti.collection("Anketler").document(anketId).setData(ustuneEkle, merge: true) { (hata) in
                                if hata == nil
                                {
                                    self.performSegue(withIdentifier: "soruIkitoAdminAna", sender: nil)
                                }
                            }
                        }
                ...
                else
                {
                    ...
                    let dbGonder = ["soruDizi" : [self.soruIkiTxt.text!] , "sikADizi" : [self.aSikkiTxt.text!], "sikBDizi" : [self.bSikkiTxt.text!], "sikCDizi" : [self.cSikkiTxt.text!] , "sikDDizi" : [self.dSikkiTxt.text!]] as! [String:Any]
                    ...
                    for anketler in snapshot!.documents
                    {
                        ...
                        if var soruDizi = anketler.get("soruDizi") as? [String]
                        {
                            ...
                            dbBaglanti.collection("Anketler").document(anketId).setData(ustuneEkle, merge: true) { (hata) in
                                if hata == nil
                                {
                                    self.performSegue(withIdentifier: "soruIkitoSoruUc", sender: nil)
                                }
                            }
                        }
                        if var sikADizi = anketler.get("sikADizi") as? [String]
