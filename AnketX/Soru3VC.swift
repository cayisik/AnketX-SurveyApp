...
class Soru3VC: UIViewController {
    @IBOutlet weak var anketAdiLbl: UILabel!
    @IBOutlet weak var soruUcTxt: UITextField!
    ...
    {
            if soruUcTxt.text != "" && aSikkiTxt.text != "" && bSikkiTxt.text != "" && cSikkiTxt.text != "" && dSikkiTxt.text != ""
            {
            ...
            let dbGonder = [ "soruUc" : soruUcTxt.text! , "soruUciaSikki" : aSikkiTxt.text! , "soruUcbSikki" : bSikkiTxt.text! , "soruUccSikki" : cSikkiTxt.text! , "soruUcdSikki" : dSikkiTxt.text!]
            ...
            if hata != nil
                {
                    ...
                    self.performSegue(withIdentifier: "soruUctoAdminAna", sender: nil)
                }
                }
                else
                {
            ...
            else
            {
                if snapshot?.isEmpty == false && snapshot != nil
                {
                    for anketler in snapshot!.documents
                    {
                        ...
                        {
                            soruDizi.append(self.soruUcTxt.text!)
                            ...
                            dbBaglanti.collection("Anketler").document(anketId).setData(ustuneEkle, merge: true) { (hata) in
                                if hata == nil
                                {
                                    self.performSegue(withIdentifier: "soruUctoSoruDort", sender: nil)
                                }
                            }
                        }
                ...
                {
                    var dbReferans : DocumentReference? = nil
                    let dbGonder = ["anketAdi" : self.anketAdiLbl.text! , "soruDizi" : [self.soruUcTxt.text!] , "sikADizi" : [self.aSikkiTxt.text!], "sikBDizi" : [self.bSikkiTxt.text!], "sikCDizi" : [self.cSikkiTxt.text!] , "sikDDizi" : [self.dSikkiTxt.text!]] as! [String:Any]
